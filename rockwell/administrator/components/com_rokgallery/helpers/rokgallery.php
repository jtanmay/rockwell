...
class RokGalleryHelper {
    ...
    public static function setupGalleryPicker(RokGalleryViewGalleryPicker &$picker_view = null)
    {
        ...
        $css_r = array();
        $css_r[] = $com_admin.'/templates/gallerypicker/gallerypicker.css?version="2.28"';
        //j1.7 specific
        ...
        $js_r[] = $com_admin.'/assets/application/Scrollbar.js?version="2.28"';
        $js_r[] = $com_admin.'/assets/application/MainPage.js?version="2.28"';
        $js_r[] = $com_admin.'/templates/gallerypicker/gallerypicker.js?version="2.28"';
